...
local settingsTable = {
        General = {
                ...
                rayfieldOpen = {Type = 'bind', Value = 'K', Name = 'V3xadoUI Keybind'},
                -- buildwarnings
                -- rayfieldprompts
...
local function loadSettings()
        ...
        local success, result = pcall(function()
                task.spawn(function()
                        ...
                        if useStudio then
                                file = [[
                {"General":{"rayfieldOpen":{"Value":"K","Type":"bind","Name":"V3xadoUI Keybind","Element":{"HoldToInteract":false,"Ext":true,"Name":"V3xadoUI Keybind","Set":null,"CallOnChange":true,"Callback":null,"CurrentKeybind":"K"}}},"System":{"usageAnalytics":{"Value":false,"Type":"toggle","Name":"Anonymised Analytics","Element":{"Ext":true,"Name":"Anonymised Analytics","Set":null,"CurrentValue":false,"Callback":null}}}}
        ]]
                        end
...
local warned
local globalLoaded
local rayfieldDestroyed = false -- True when V3xadoUILibrary:Destroy() is called
...
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://raw.githubusercontent.com/SiriusSoftwareLtd/V3xadoUI/refs/heads/main/icons.lua')
-- Variables
...
local function LoadConfiguration(Configuration)
        ...
        for FlagName, Flag in pairs(V3xadoUILibrary.Flags) do
                ...
                if (typeof(FlagValue) == 'boolean' and FlagValue == false) or FlagValue then
                        ...
                        --V3xadoUILibrary:Notify({Title = "V3xadoUI Flags", Content = "V3xadoUI was unable to find '"..FlagName.. "' in the save file. Check sirius.menu/discord for help.", Image = 3944688398})
                end
        end
...
local function Hide(notify: boolean?)
        ...
        if notify then
                if useMobilePrompt then 
                        ...
                        V3xadoUILibrary:Notify({Title = "Interface Hidden", Content = `The interface has been hidden, you can unhide the interface by tapping {getSetting("General", "rayfieldOpen")}.`, Duration = 7, Image = 4400697855})
                end
        end
